        ...
        implements WorkerSessionPropertyProvider
{
    ...
    public static final String NATIVE_OPTIMIZED_PARTITIONED_OUTPUT_ENABLED = "optimized_partitionedoutput";
    public static final String NATIVE_OPTIMIZED_HASH_PARTITION_FUNCTION_ENABLED = "optimized_hash_partition_function_enabled";
